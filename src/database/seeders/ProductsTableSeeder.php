...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            'name' => 'キウイ',
            'price' => 800,
            'image' => 'storage/fruits-img/kiwi.jpg',
        ...
        $param = [
            'name' => 'ストロベリー',
            'price' => 1200,
            'image' => 'storage/fruits-img/strawberry.jpg',
        ...
        $param = [
            'name' => 'オレンジ',
            'price' => 850,
            'image' => 'storage/fruits-img/orange.jpg',
        ...
        $param = [
            'name' => 'スイカ',
            'price' => 700,
            'image' => 'storage/fruits-img/watermelon.jpg',
        ...
        $param = [
            'name' => 'ピーチ',
            'price' => 1000,
            'image' => 'storage/fruits-img/peach.jpg',
        ...
        $param = [
            'name' => 'シャインマスカット',
            'price' => 1400,
            'image' => 'storage/fruits-img/muscat.jpg',
        ...
        $param = [
            'name' => 'パイナップル',
            'price' => 800,
            'image' => 'storage/fruits-img/pineapple.jpg',
        ...
        $param = [
            'name' => 'ブドウ',
            'price' => 1100,
            'image' => 'storage/fruits-img/grapes.jpg',
        ...
        $param = [
            'name' => 'バナナ',
            'price' => 600,
            'image' => 'storage/fruits-img/banana.jpg',
        ...
        $param = [
            'name' => 'メロン',
            'price' => 900,
            'image' => 'storage/fruits-img/melon.jpg',
